...
public class AndroidTicTacToeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idPhone = android.os.Build.DEVICE;
    ...
    protected Dialog createdDialog(int id) {
        ...
        switch (id) {
            case DIALOG_WAIT_ID:
                builder.setTitle("Created private match");
                builder.setMessage("Awaiting for other players to join"+"\n\nThe room name is: "+idGame)
                        .setCancelable(false)
            ...
            case DIALOG_JOIN_ID:
                ...
                builder.setTitle("Join private match");
                final CharSequence[] nGames = games.toArray(new String[games.size()]);
                builder.setMessage("1/1 rooms available\n");
    ...
    private void newOnlineGame(boolean join){
        ...
        if (!humanstart) {
            mInfoTextView.setTypeface(null, Typeface.NORMAL);
            mInfoTextView.setText("P1 Turn");
            humanturn = false;
        }else {
            humanturn = true;
            mInfoTextView.setText("P2 Starts");
            mInfoTextView.setTypeface(null, Typeface.NORMAL);
        }
    }
